        ...
        $.ajax({
            ...
            success: function(get_place_photos_response) {
                ...
                get_place_photos_response.forEach((photo, i) => {
                    ...
                    photo_html = photo_html + '<a href="/media/img/places/' + photo.image.replace(/^.*[\\\/]/, '') +  '" data-lightbox="image-1" data-title="' + photo.caption + '"><img class="img_place" src="/media/img/places/' + photo.image.replace(/^.*[\\\/]/, '') +  '" /></a>';
                });
